...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-plus mr-1"></i> Form Tambah Bimbingan Konseling</h3>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select name="kategori" class="form-control @error('kategori') is-invalid @enderror" required>
                    ...
                    <option value="pribadi" {{ old('kategori') === 'pribadi' ? 'selected' : '' }}>Bidang Bimbingan Pribadi</option>
                    <option value="sosial" {{ old('kategori') === 'sosial' ? 'selected' : '' }}>Bidang Bimbingan Sosial</option>
                    <option value="belajar" {{ old('kategori') === 'belajar' ? 'selected' : '' }}>Bidang Bimbingan Belajar</option>
                    <option value="karir" {{ old('kategori') === 'karir' ? 'selected' : '' }}>Bidang Bimbingan Karir</option>
                </select>
            ...
            <div class="form-group">
                ...
                <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" 
                    rows="5" placeholder="Masukkan catatan bimbingan..." required>{{ old('catatan') }}</textarea>
