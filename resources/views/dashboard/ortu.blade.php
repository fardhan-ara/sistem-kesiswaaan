        ...
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                @else
                    ...
                    <p class="text-muted">{{ $message ?? 'Silakan lengkapi biodata terlebih dahulu.' }}</p>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body text-center">
                @if(isset($biodata) && $biodata->foto_kk)
                    <p class="text-muted mb-2"><strong>Foto Kartu Keluarga (KK)</strong></p>
                    <img src="{{ asset('storage/' . $biodata->foto_kk) }}" alt="Foto KK" class="img-fluid" style="max-height: 300px; border: 1px solid #ddd; border-radius: 5px;">
                    <div class="mt-2">
                        <a href="{{ asset('storage/' . $biodata->foto_kk) }}" target="_blank" class="btn btn-sm btn-primary">
            ...
            <div class="card-body">
                @if($totalPoin >= 51)
                    <div class="alert alert-danger">
                        ...
                        Total poin: <strong>{{ $totalPoin }}</strong><br>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($s->status_sanksi == 'sedang_dilaksanakan')
