    ...
    <div class="right-panel">
        <div class="login-form-container">
            ...
            <div class="mt-3 text-center">
                <a href="#" id="forgotPasswordLink" data-url="<?php echo e(route('password.email')); ?>">Lupa password?</a>
            </div>
            <div class="mt-2 text-center">
                ...
                <div class="dropdown d-inline">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?php echo e(route('signup', ['role' => 'kesiswaan'])); ?>">Staff Kesiswaan</a>
                        <a class="dropdown-item" href="<?php echo e(route('signup', ['role' => 'guru'])); ?>">Guru</a>
                        <a class="dropdown-item" href="<?php echo e(route('signup', ['role' => 'wali_kelas'])); ?>">Wali Kelas</a>
                        <a class="dropdown-item" href="<?php echo e(route('signup', ['role' => 'siswa'])); ?>">Siswa</a>
                        <a class="dropdown-item" href="<?php echo e(route('signup', ['role' => 'ortu'])); ?>">Orang Tua</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\sistem-kesiswaan\resources\views/auth/login.blade.php ENDPATH**/ ?>