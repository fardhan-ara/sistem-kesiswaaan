            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" id="loginForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" autocomplete="username" required placeholder="">
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('signup', ['role' => 'siswa'])); ?>" class="btn btn-outline-primary btn-lg">
                        <i class="fas fa-user-graduate"></i> Daftar sebagai Siswa
                    </a>
                    <a href="<?php echo e(route('signup', ['role' => 'guru'])); ?>" class="btn btn-outline-success btn-lg">
                        <i class="fas fa-chalkboard-teacher"></i> Daftar sebagai Guru
                    </a>
                    <a href="<?php echo e(route('signup', ['role' => 'kesiswaan'])); ?>" class="btn btn-outline-info btn-lg">
                        <i class="fas fa-user-tie"></i> Daftar sebagai Kesiswaan
                    </a>
                    <a href="<?php echo e(route('signup', ['role' => 'bk'])); ?>" class="btn btn-outline-secondary btn-lg">
                        <i class="fas fa-comments"></i> Daftar sebagai Guru BK
                    </a>
                    <a href="<?php echo e(route('signup', ['role' => 'ortu'])); ?>" class="btn btn-outline-warning btn-lg">
...
<?php /**PATH C:\xampp\htdocs\sistem-kesiswaan\resources\views/landing.blade.php ENDPATH**/ ?>